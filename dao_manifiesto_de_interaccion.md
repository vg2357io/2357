...
| Contexto | Acción / Resultado | Variación de Reputación |
| --- | --- | --- |
| **Interacciones dirigidas** | Trato Bueno | **+23 puntos** |
|  | Trato Neutro | **+7 puntos** |
|  | Trato Indiferente | **0 puntos** |
|  | Trato Malo | **−7 puntos** |
| **Encuestas de decisión** | Respuesta afín al personaje | **+23 puntos** |
|  | Cualquier otra respuesta | **+7 puntos** |
| **Ecosistemas Autónomos** | Transacciones comerciales y sociales | **Variable (+ / −)** |
...
$$\text{Votos Efectivos} = \left( \frac{\text{Reputación Actual}}{2357} \right) \times \text{Votos por Qubits}$$
